...
class CosV5PythonSDKTest(object):
    def __init__(self, appid, secret_id, secret_key, end_point,
                 scheme):
        self.appid = appid
...
if __name__ == "__main__":
    ...
    main = CosV5PythonSDKTest(
        # region="",
        appid="1258489444",
        secret_id="AKIDWsmaQ4BUHqEP8kDSdaJJyQbgdR2e5Qid",
        secret_key="bzAUpupa5MNLU7UbUBcdRqzrESRnw4OS",
        end_point="cos.ap-guangzhou",
        scheme="https")
