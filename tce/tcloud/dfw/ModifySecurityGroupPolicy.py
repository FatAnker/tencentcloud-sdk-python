...
config = {
    'Region': 'shanghai',
    'secretId': 'AKIDXhX2D3ad3B0UcPe0pLWMVK8cpiHVtBvL',
    'secretKey': 'F9iw4sLTFgmX2D3ZlGdfSx82bphEQHmw',
    'method': 'GET',
...
action_params = {
     "sgId": "sg-md51fev6",
    "ingress":[{"ipProtocol":"tcp","cidrIp":"10.0.0.2","action":"ACCEPT","portRange":22,"desc":"内网入流量tcp协议22端口禁止访问"}],
    "egress":[{"action":"ACCEPT","ipProtocol":"tcp","desc":"内网tcp出流量放通","cidrIp":"10.0.0.5"}]
}
